...
- `cdi-power-board/` for high-voltage charging, storage, discharge, CDI coil output, and the pre-schematic checklist.
...
Pre-schematic CDI power-board review starts at [cdi-power-board/schematic-checklist.md](cdi-power-board/schematic-checklist.md).
